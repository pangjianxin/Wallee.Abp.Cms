<template>
   <v-dialog transition="dialog-top-transition" width="100%" :fullscreen="themeStore.mobile" :model-value="show"
      ...
      <v-form v-model="updateFormValid" ref="updateFormRef" @submit.prevent="onSubmitUpdateIdentityUser">
         <v-card>
            <v-toolbar color="primary" extended>
               ...
               <v-spacer></v-spacer>
               <v-btn icon="mdi-power" @click="closeDialog"></v-btn>
                     ...
                     <v-row class="mt-2">
                        ...
                        <v-col cols="12" md="6">
                           <v-text-field label="更新密码" v-model="updateForm.password" autocomplete="off" density="compact"
                              ...
                              placeholder="输入新密码(如需变更)" :append-inner-icon="passwordShow ? 'mdi-eye' : 'mdi-eye-off'"
