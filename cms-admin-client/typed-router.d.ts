...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'blogPost.detail': RouteRecordInfo<'blogPost.detail', '/blogPosts/:blogPostId', { blogPostId: ParamValue<true> }, { blogPostId: ParamValue<false> }>,
    'blogPost.create': RouteRecordInfo<'blogPost.create', '/blogPosts/create/:blogId', { blogId: ParamValue<true> }, { blogId: ParamValue<false> }>,
    'blogPost.edit': RouteRecordInfo<'blogPost.edit', '/blogPosts/edit/:blogPostId', { blogPostId: ParamValue<true> }, { blogPostId: ParamValue<false> }>,
    ...
    'identity.user.index': RouteRecordInfo<'identity.user.index', '/identity/users', Record<never, never>, Record<never, never>>,
    'login': RouteRecordInfo<'login', '/login', Record<never, never>, Record<never, never>>,
    'tenant.index': RouteRecordInfo<'tenant.index', '/tenants', Record<never, never>, Record<never, never>>,
  }
}
