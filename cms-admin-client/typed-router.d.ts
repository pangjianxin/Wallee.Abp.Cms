...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'blogPost.index': RouteRecordInfo<'blogPost.index', '/cms/blogPosts', Record<never, never>, Record<never, never>>,
    'blogPost.detail': RouteRecordInfo<'blogPost.detail', '/cms/blogPosts/:blogPostId', { blogPostId: ParamValue<true> }, { blogPostId: ParamValue<false> }>,
